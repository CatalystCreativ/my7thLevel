...
const LEVEL_ONE = {
  ...
  actionExamples: "1. A six year old ignores their teacher when they ask a question to the class.
  ...
  questionExamples: "1. Have I ever asked my employees how they like to be communicated with?
  ...
  goalExamples: "1. Conduct an informal survey to find out whether my audience perfers emails or text messages.
...
const LEVEL_TWO = {
  ...
  questionDescription: "List the Questions associated with those actions",
  questionExamples: "1. Do I use jargon or technical language too often?
                     2. Is my messaging clear concise and simple?
                     3. Which version of ad copy is easiest to understand for my audience?",
  goalDescription: "Choose 1-2 goals for the next month or quarter",
  goalExamples: "1. Test email content that is written vs explained in a short video.
...
const LEVEL_THREE = {
  ...
  actionDescription: "Define the action that represents this level for you/your company",
  actionExamples: "1. A 6-year old is in interested in their assignment until they can't use their favorite marker.
                   2. Employees express interest in joining the weight loss program, but then no one finishes the steps to
                   sign up.
  ...
  questionDescription: "List the Questions associated with those actions",
  questionExamples: "1. Are their too many steps or are the steps to join too difficult?
                     2. Does my website load quickly enough?
                     3. Am I rarely available when my friends aske me to join them for activities?",
  goalDescription: "Choose 1-2 goals for the next month or quarter",
  goalExamples: "1. Set up a web form to make signing up got my employee program easy.
...
const LEVEL_FOUR = {
  ...
  questionDescription: "List the Questions associated with those actions",
  questionExamples: "1. Am I providing enough of an incentive or connection that it excites people to participates?
                     2. What kind of engagement am I looking for?
                     3. What action am I really asking people to take?",
  goalDescription: "Choose 1-2 goals for the next month or quarter",
  goalExamples: "1. Increase employee participation in meetings by 20%.
...
const LEVEL_FIVE = {
  ...
  questionDescription: "List the Questions associated with those actions",
  questionExamples: "1. Am I offering the right incentive to boost the type of engagement I am looking for?
...
it inspired me to do the same.",
  questionDescription: "List the Questions associated with those actions",
  questionExamples: "1. What do I stand for?
                     2. Why does what I or my comany matter?
                     3. How is our brand helping others?",
  goalDescription: "Choose 1-2 goals for the next month or quarter",
  goalExamples: "1. Increase positive testimonials and/or reviews.
...
const LEVEL_SEVEN = {
  ...
  questionDescription: "List the Questions associated with those actions",
  questionExamples: "1. How am I delighting this level of people?
  ...
  goalDescription: "Choose 1-2 goals for the next month or quarter",
  goalExamples: "1. Increase employee retention.
